...
class MysqlUnsMediumint extends Validator
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'Is mysql unsigned mediumint';
    }
    ...
    protected function prove(array $extra = []): bool
    {
        ...
        return $this->value >= Abs::MYSQL_MEDIUMINT_UNS_MIN && $this->value <= Abs::MYSQL_MEDIUMINT_UNS_MAX;
    }
    ...
    {
        return [Abs::MYSQL_MEDIUMINT_UNS_MIN, Abs::MYSQL_MEDIUMINT_UNS_MAX];
    }
