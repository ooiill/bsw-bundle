...
/**
 * @ORM\Entity(repositoryClass="Leon\BswBundle\Repository\BswAdminRoleAccessControlRepository")
 * @UniqueEntity(fields={"roleId", "routeName"}, errorPath="roleId,routeName", message="Record exists.", groups={"modify", "newly"})
 */
class BswAdminRoleAccessControl extends FoundationEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
